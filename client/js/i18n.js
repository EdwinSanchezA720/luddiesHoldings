...
(function () {
    ...
    var translations = {
        es: {
            ...
            reg_error_name: "Ingresa un nombre válido (mínimo 2 caracteres).",
            reg_error_email: "Ingresa un correo electrónico válido.",
            reg_error_phone: "Ingresa un teléfono válido (8 a 20 dígitos o con +).",
            reg_error_password_len: "La contraseña debe tener al menos 6 caracteres.",
            ...
            admin_hero_lead: "Productos y cuentas de usuario (demo en el navegador).",
        ...
        en: {
            ...
            reg_error_name: "Enter a valid name (at least 2 characters).",
            reg_error_email: "Enter a valid email address.",
            reg_error_phone: "Enter a valid phone (8–20 digits, optional +).",
            reg_error_password_len: "Password must be at least 6 characters.",
            ...
            admin_hero_lead: "Products and user accounts (browser demo).",
