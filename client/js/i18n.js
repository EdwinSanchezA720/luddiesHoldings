...
(function () {
    ...
    var translations = {
        es: {
            ...
            home_hero_lead:
                "Conectamos a docentes, familias y creadores con material estandarizado en espanol: digitales hoy, kits y certificacion en expansion.",
            ...
            home_value_title: "Por que Luddies",
            home_value_subtitle: "Un marketplace pensado para quien ensena y para quien aprende.",
            ...
            home_val_spanish_title: "STEM en espanol, alineado a la region",
            home_val_spanish_desc:
                "Contenido actualizado para contextos latinoamericanos, empezando por Mexico con miras regionales.",
            home_val_standard_title: "Estandarizacion que ahorra tiempo",
            home_val_standard_desc:
                "Jerarquia clara: enfoque, tema, clase y actividad de refuerzo. Menos horas buscando, mas horas ensenando.",
            home_lines_title: "Que encontraras en el catalogo",
            home_line_digital_title: "Activos digitales",
            home_line_digital_desc:
                "PDFs, actividades, posters, presentaciones dinamicas y scripts de planeacion de clase.",
            ...
            home_line_cert_title: "Certificacion educativa",
            home_line_cert_desc: "Rutas alineadas a estandares tipo SEP, nivel basico, con expansion futura.",
            home_line_kits_title: "Kits de experiencias (proximamente)",
            home_line_kits_desc: "Materiales fisicos con narrativa, dinamicas y codigos para el aula.",
            home_hierarchy_title: "Como organizamos el material",
            home_hierarchy_subtitle: "Una estructura comun para todos los activos.",
            ...
            home_girls_lead:
                "Seccion dedicada a visibilizar y apoyar a las ninas y mujeres en carreras cientificas y tecnologicas.",
            home_girls_cta: "Ver material en el catalogo",
            home_featured_title: "Destacados del catalogo",
            home_feat_1_title: "Ciencias con experimentos guiados",
            home_feat_1_desc: "Secuencias listas para secundaria con enfoque practico.",
            home_feat_2_title: "Programacion creativa",
            home_feat_2_desc: "Actividades introductorias de pensamiento computacional.",
            ...
            home_cta_band_lead: "Escríbenos para publicar material o integrar Luddies en tu institucion.",
            home_cta_band_catalog: "Ver catalogo",
        ...
        en: {
            ...
            home_girls_title: "Girls in STEM",
            home_girls_lead:
                "A dedicated space to highlight and support girls and women pursuing scientific and technical paths.",
            ...
            home_feat_2_title: "Creative programming",
            home_feat_2_desc: "Introductory activities for computational thinking.",
