...
-- Categories (slugs match the frontend catalog filters)
...
INSERT INTO users (id, email, password_hash, full_name, phone_dial, phone_number, role_id, preferred_language, is_active, created_at) VALUES
  ...
  (3, 'maria.lopez@ejemplo.com',   @pwd_demo, 'María López',   '+52', '5551234567', 2, 'es', 1, '2025-02-01 11:00:00'),
  (4, 'carlos.ruiz@ejemplo.com',   @pwd_demo, 'Carlos Ruiz',   '+52', '3319876543', 2, 'en', 1, '2025-02-05 15:20:00'),
  (5, 'ana.martinez@ejemplo.com',  @pwd_demo, 'Ana Martínez',  '+52', '8181234567', 2, 'es', 1, '2025-03-01 10:00:00'),
  (6, 'jorge.sanchez@ejemplo.com', @pwd_demo, 'Jorge Sánchez', '+52', '5559876543', 2, 'es', 1, '2025-03-10 08:30:00');

-- Products
-- Items 1-12 come from the original frontend seed (catalog-seed.js)
-- Items 13-14 are custom products created from the admin panel (is_custom = 1)
...
-- Product categories (some products belong to more than one category)
...
-- Carts with different lifecycle statuses
...
-- Orders: one guest checkout, two from registered users
INSERT INTO orders (
...
-- Payments with varied card details
